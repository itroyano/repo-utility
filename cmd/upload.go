...
var uploadCmd = &cobra.Command{
	...
	PreRunE: func(cmd *cobra.Command, args []string) error {
		opClient, err := operator.Newrepo - utilityClient()
		if err != nil {
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// for each line is stdout.json which is provided by repo-utility create an Audit object and add to the rawreport Audits field.
